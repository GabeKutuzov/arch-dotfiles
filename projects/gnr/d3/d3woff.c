/* (c) Copyright 1987-2008, The Rockefeller University *11116* */
/* $Id: d3woff.c 74 2017-09-18 22:18:33Z  $ */
/***********************************************************************
*                             CNS Program                              *
*                               d3woff                                 *
...
*  V74, 07/20/17, GNR - Change return value to ulng, check for negs    *
***********************************************************************/
...
ulng d3woff(struct CONNTYPE *ix) {
   ...
   /* N.B.  The right shifts have to be separately on x and y
   *  otherwise get incorrect half-column offsets.  */
   xoff -= ix->nux;
   if (xoff < 0) xoff = 0;
   else xoff >>= 1;
   yoff -= ix->nuy;
