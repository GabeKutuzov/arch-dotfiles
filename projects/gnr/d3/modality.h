...
/* $Id: modality.h 70 2017-01-16 19:27:55Z  $ */
/***********************************************************************
*                             CNS Program                              *
...
struct MODALITY {
   ...
   xrmt *pnr;                 /* Ptr to number of responses by isn */
   ...
   mdlt_type mdltbid;         /* Bit identifier (based on mdltno)  */
   ui16  mdltboff;            /* Byte offset of isn bits in pmbits */
   ui16  mdltgoff;            /* Byte offset of ign bits in pmbits */
   ui16  mdltnoff;            /* Byte offset of new ign  in pmbits */
