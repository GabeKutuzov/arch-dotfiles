/* (c) Copyright 1992-2005, Neurosciences Research Foundation, Inc. */
/* $Id: d3ucvt.c 46 2011-05-20 20:14:09Z  $ */
/***********************************************************************
*                          CNS-Hybrid Program                          *
*                              d3ucvt.c                                *
...
*  defined in nsitools.h.  The arguments are discussed further in      *
*  nncom.c.                                                            *
*                                                                      *
...
void NXFuni_CNul1_u(
   ...
   /* Set 'ptable' to point to the appropriate conversion table */
   if (ix->kgen & (KGNGP|KGNHG|KGNJN|KGNND|KGNOG|KGNUD))
