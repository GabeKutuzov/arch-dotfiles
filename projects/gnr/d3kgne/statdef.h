...
/* $Id: statdef.h 44 2011-03-04 22:36:14Z  $ */
/***********************************************************************
*                             CNS Program                              *
*                         STATDEF Header File                          *
*                                                                      *
...
/* Structure to define a stimulus group */

struct GSDEF {             /* Stimulus group statistics definition */
   long ng;                /* Total responses to jth class of stimuli
                           *  = sum over all cells of nhtj */
   long nhtj;              /* Number of hits to stimuli in class j
                           *  by cell currently being processed.  */
   long nstj;              /* Number of stimuli in class j */
...
struct STDEF {
   long *pxrmtx;              /* Ptr to cross-response matx (host) */
