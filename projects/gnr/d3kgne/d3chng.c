...
/* $Id: d3chng.c 52 2012-06-01 19:54:05Z  $ */
/***********************************************************************
*                             CNS Program                              *
*                              d3chng()                                *
*                         Process CHANGE card                          *
...
#define ChSS    0x20          /* Variable requires subscript */
...
static char *errtxt[] = {
      ...
      " ***ILLEGAL FOFF WITH OPT=X AND BC=TOROID.",
      " ***SCALE AT \"$\" OVERFLOWED.",
...
{"AHP",    "B20/27IL$mV", DST,       rfrcdata, ofl(RFRCDATA,      ahp)},
{"ASMNIMM","V>0<1B24IJ",  0,         autscl,   ofl(AUTSCL,    asmnimm)},
{"ASMXD",  "V>0<1B24IJ",  0,         autscl,   ofl(AUTSCL,      asmxd)},
{"ASMXIMM","V>0<10B24IJ", 0,         autscl,   ofl(AUTSCL,    asmximm)},
{"BETA",   "-",           ChSS,      getbeta                          },
{"BGA",    "B24IJ$nS",    IZVU,      bregrf,   ofl(BREGDEF,       bga)},
{"BGB",    "B20/27IJ$nA", IZVU,      bregrf,   ofl(BREGDEF,       bgb)},
{"BGDELT","V>B20/27IJ$mV",IZVU,      bregrf,   ofl(BREGDEF,      delT)},
{"BGGL",   "B20UJ$nS",    IZVU,      bregrf,   ofl(BREGDEF,        gL)},
{"BGTAUW", "V>B20UJ$ms",  IZVU,      bregrf,   ofl(BREGDEF,      tauW)},
{"BGVPEAK","B20/27IJ$mV", IZVU,      bregrf,   ofl(BREGDEF,     vPeak)},
{"BGVRESET","B20/27IJ$mV",IZVU,      bregrf,   ofl(BREGDEF,    vReset)},
{"BGVT",   "B20/27IJ$mV", IZVU,      bregrf,   ofl(BREGDEF,        vT)},
{"CM",     "V>8B23UJ$pF", 0,         layer,    ofl(CELLTYPE,    Ct.Cm)},
{"COLOR",  "-",           ChALR,     sicolor                          },
{"DAMPFACT","V<=1B15UH",  SBAR,      layer,    ofl(CELLTYPE, Dc.sdamp)},
{"DECAY",  "-",           ChDCV,     layer,    ofl(CELLTYPE,  Dc.CDCY)},
{"DELAY",  "VIC",         ChSS,      conntype, ofl(CONNTYPE,Cn.retard)},
{"DELTA",  "B28IL",       ChSS,      conntype, ofl(CONNTYPE, Cn.delta)},
{"DVI",    "VIH",         ChSS+CIJ0, conntype, ofl(CONNTYPE,   Cn.dvi)},
{"EQUIL",  "B16IL",       ChSS,      conntype, ofl(CONNTYPE,Cn.target)},
...
{"GAMMA",  "B24IL",       ChSS,      conntype, ofl(CONNTYPE, Cn.gamma)},
...
{"HR",     "VF",          ChSS,      gcontype, ofl(INHIBBLK,   hlfrad)},
{"HT",     "B20/27IL$mV", 0,         layer,    ofl(CELLTYPE,    Ct.ht)},
...
{"I3A",    "B28IJ",       IZVU,      iz03rf,   ofl(IZ03DEF,     Z.iza)},
{"I3B",    "B28IJ",       IZVU,      iz03rf,   ofl(IZ03DEF,     Z.izb)},
{"I3C",    "B20/27IJ$mV", IZVU,      iz03rf,   ofl(IZ03DEF,     Z.izc)},
{"I3CV0",  "B20/27IJ$mV", IZVU,      iz03rf,   ofl(IZ03DEF,     izcv0)},
{"I3CV1",  "B24IJ",       IZVU,      iz03rf,   ofl(IZ03DEF,     izcv1)},
{"I3CV2","V~B30/23IJ$-/mV",IZVU,     iz03rf,   ofl(IZ03DEF,     izcv2)},
{"I3D",    "B22/29IJ$mV", IZVU,      iz03rf,   ofl(IZ03DEF,     Z.izd)},
{"I3VPEAK","B20/27IJ$mV", IZVU,      iz03rf,   ofl(IZ03DEF,   Z.vpeak)},
{"I3VUR",  "B20/27IJ$mV", IZVU,      iz03rf,   ofl(IZ03DEF,     Z.vur)},
{"I7A",    "B28IJ",       IZVU,      iz07rf,   ofl(IZ07DEF,     Z.iza)},
{"I7B",    "B23IJ",       IZVU,      iz07rf,   ofl(IZ07DEF,      iizb)},
{"I7BVLO", "B23IJ",       IZVU,      iz07rf,   ofl(IZ07DEF,      bvlo)},
{"I7C",    "B20/27IJ$mV", IZVU,      iz07rf,   ofl(IZ07DEF,     Z.izc)},
{"I7D",    "B19/26IJ$mV", IZVU,      iz07rf,   ofl(IZ07DEF,      iizd)},
{"I7K",    "VB24/17IJ",   IZVU,      iz07rf,   ofl(IZ07DEF,       izk)},
{"I7UMAX", "B19/26IJ$mV", IZVU,      iz07rf,   ofl(IZ07DEF,      umax)},
{"I7UMC",  "B28IJ",       IZVU,      iz07rf,   ofl(IZ07DEF,       umc)},
{"I7UMVP", "B28IJ",       IZVU,      iz07rf,   ofl(IZ07DEF,      umvp)},
{"I7UV3",  "B30IJ",       IZVU,      iz07rf,   ofl(IZ07DEF,       uv3)},
{"I7UV3LO","B30IJ",       IZVU,      iz07rf,   ofl(IZ07DEF,     uv3lo)},
{"I7VPEAK","B20/27IJ$mV", IZVU,      iz07rf,   ofl(IZ07DEF,   Z.vpeak)},
{"I7VT",   "B20/27IJ$mV", IZVU,      iz07rf,   ofl(IZ07DEF,      izvt)},
{"I7VUR",  "B20/27IJ$mV", IZVU,      iz07rf,   ofl(IZ07DEF,     Z.vur)},
{"KCTP",   "-",           ChALR+ChKEY,kctpcode                        },
{"KP",     "-",           ChRPL+ChKEY,krpcode                         },
...
{"MTV",    "B8IH",        ChSS,      conntype, ofl(CONNTYPE,   Cn.mtv)},
{"MXAX",   "B20/27IJ$mV", ChSS,      conntype, ofl(CONNTYPE,  Cn.mxax)},
{"MXIB",   "-",           ChSS,      getmxib                          },
{"MXMIJ",  "B7/14IH$mV",  ChSS+MIJ,  conntype, ofl(CONNTYPE, Cn.mxmij)},
{"MXMOD",  "B20/27IL$mV", ChSS,      modtype,  ofl(MODBY,       mxmod)},
{"MXMP",   "VB13/20IL$mV",ChSS+MIJ,  conntype, ofl(CONNTYPE,  Cn.mxmp)},
{"NAPC",   "N" KWS_NAPC,  ChSS,      conntype, ofl(CONNTYPE,  Cn.napc)},
{"NGTHT",  "VIJ",         0,         autscl,   ofl(AUTSCL,      ngtht)},
{"NT",     "B20/27IL$mV", 0,         layer,    ofl(CELLTYPE,    Ct.nt)},
{"OMEGA1", "V>=0<=1B30IL",0,         layer,    ofl(CELLTYPE,Dc.omega1)},
{"OMEGA2", "-",           ChDCV,     layer,    ofl(CELLTYPE,  Dc.CDCY)},
{"OMEGAD", "V>0<=1B30IL", DEPR,      layer,    ofl(CELLTYPE,Dp.omegad)},
{"OMEGADST","V>=0<1B30IL",DST,       rfrcdata, ofl(RFRCDATA, omegadst)},
...
{"PRADI",  "IL",          ChSS,      conntype, ofl(CONNTYPE,    pradi)},
{"PRADJ",  "IL",          ChSS,      conntype, ofl(CONNTYPE,    pradj)},
{"PSDST",  "B20/27IL$mV", DST,       rfrcdata, ofl(RFRCDATA,    psdst)},
{"PT",     "B20/27IL$mV", 0,         layer,    ofl(CELLTYPE,    Ct.pt)},
...
{"SCALE",  "B24IL",       ChSS+ChScl,conntype, ofl(CONNTYPE,   Cn.scl)},
{"SDAMP",  "V<=1B15UH",   SBAR,      layer,    ofl(CELLTYPE, Dc.sdamp)},
{"SHAPE",  "-",           ChALR,     sishape                          },
{"SIET",   "B20/27IL$mV", 0,         layer,    ofl(CELLTYPE,  Dc.siet)},
...
{"ST",     "B20/27IL$mV", 0,         layer,    ofl(CELLTYPE,    Ct.st)},
{"SVITMS", "-",           ChSS+ChKEY,lsvitms                          },
{"THAMP",  "VB20/27IJ$mV",0,         layer,    ofl(CELLTYPE, Ct.stanh)},
{"UPSD",   "VB27/20IL",   DEPR,      layer,    ofl(CELLTYPE,  Dp.upsd)},
{"UPSDST", "VB16IL",      DST,       rfrcdata, ofl(RFRCDATA,   upsdst)},
{"UPSM",   "VB16IL",      ChSS+MIJ,  conntype, ofl(CONNTYPE,  Cn.upsm)},
{"VDHA",  "V~B20/27IL$mV",ChSS,      conntype, ofl(CONNTYPE,  Cn.vdha)},
{"VDT",    "B20/27IL$mV", ChSS,      conntype, ofl(CONNTYPE,   Cn.vdt)},
{"VI",     "UH",          ChSS,      conntype, ofl(CONNTYPE,    Cn.vi)},
{"VXO",    "F",           ChRPL,     rep,      ofl(REPBLOCK,      vxo)},
{"VYO",    "F",           ChRPL,     rep,      ofl(REPBLOCK,      vyo)},
...
{"ZETAM",  "VB16IL",      ChSS+MIJ,  conntype, ofl(CONNTYPE, Cn.zetam)},
};
...
/* Scan and interpret current CHANGE card */
   ...
   for (;;) {
      ...
      *  is not called because we want to use our own error call.  */
      ...
      /* If the name has an index number appended, call ibcdin to get
      ...
      *  are to be affected.  Truncate the name to remove the index. */
      ...
      if (i < RK.length) {
         ++i;
         ndx = ibcdin(RK_QPOS+RK_IORF+(RK.length-i),fldbuf+i);
      ...
      */
      ...
      else if (pchop->flags & ChThr)   /* Waste thresholds */
         scan(fldbuf, RK_REQFLD|RK_PMEQPM);
...
case sicolor:              /* Celltype plot color source */
         {  struct CELLTYPE *jl;    /* Celltype loop ptr */
            RP0->GCtD.ksipce = 0;   /* Flag nothing entered */
            getsicol(&RP0->GCtD);   /* Use GCtD area as a temp */
            for (jl = ir->play1; jl; jl = jl->play) {
               if (il == NULL || jl == il) {
                  if (RP0->GCtD.ksipce & SIC_COLE) strncpy(
                     jl->Ct.sicolor, RP0->GCtD.sicolor, COLMAXCH);
                  if (RP0->GCtD.ksipce & SIC_SOPE) {
                     jl->Ct.kctp &= ~KRPCO;
                     jl->Ct.kctp |= RP0->GCtD.kctp & KRPCO; }
                  if (RP0->GCtD.ksipce & SIC_MASK) {
                     jl->Ct.ksipce &= ~SIC_MASK;
                     jl->Ct.ksipce = RP0->GCtD.ksipce & SIC_MASK; }
                  }
               } /* End celltype loop */
            } /* End sicolor local scope */
         break;
         ...
         for (ix=il->pct1; ix; ix=ix->pct) {
            ...
            *  cated data that have not actually been allocated */
            if (allo_flag && ix->cnoff[allo_flag] < DVREQ)
               chng_exit(eoptstor, RK_MARKFLD);
            /* Generate error if EPSP decay requested and input
            *  has phase.  */
            if (pchop->flags & ChDCV && ix->phopt &
               (PHASJ|PHASR|PHASC|PHASU)) errmsg(eadecay);
            /* If variable is scale, handle old-style normalizing */
            if (pchop->flags & ChScl && (RP->compat&OLDSCALE)) {
               ...
               } /* End handling new scale */
            else if (pchop->flags & ChThr) { /* Threshold type */
               RP0->ksrctyp = ix->cnsrctyp;
               scanagn();
               getthr(pchop->esfc, (short *)(pvar + pchop->offs));
               }
            else memcpy(pvar + pchop->offs,
               (char *)&newval, pchop->len);
...
case krpcode:              /* Repertoire krp flags */
         ...
         *  kctp flags from krp flags deleted, 12/27/07.  This
         *  function is now accomplished by kctpcode below.  */
         break;

case kctpcode:             /* Celltype kctp flags */
         {  struct CELLTYPE *jl;    /* Celltype loop ptr */
            /* Store new option codes */
            mcodes(fldbuf, okctkrp, NULL);

            /* Modify kctp flags for named celltype, or for all cell
            ...
            *  Make sure that if any of C,G,H,X,Y,Z flags is set,
            *  suitable bits defining a superset of the needed storage
            *  were set when the cell type was originally defined.
            *  (Checked by grep on kxr and kctp, 8/31/10.)  */

            for (jl = ir->play1; jl; jl = jl->play) {
               if (il == NULL || jl == il) {
                  mcodopl(&jl->Ct.kctp);
                  if (RP->CP.runflags & RP_NOSTAT) {
                     jl->Ct.kctp &= ~(KRPXR|KRPHR|KRPYM|KRPZC|KRPCL|
                        KRPGP|KRPMG|KRPFD);
                     jl->Ct.kctp |= CTPNS; }
                  else {
#define NKCTPT 4     /* Number of tests */
                     static const ui32 kctptb[NKCTPT] = {
                        KRPXRM,                    /* pxxxx,pnr */
                        KRPXR|KRPYM|KRPZC|KRPHR,   /* XRM alloc */
                        KRPXR|KRPGP|KRPMG|KRPCL,   /* GRPNOS */
                        KRPYM|KRPZC };             /* xresp mtx */
                     int itest;
                     for (itest=0; itest<NKCTPT; ++itest) {
                        if (jl->Ct.kctp & kctptb[itest] &&
                           !(jl->urkctp & kctptb[itest]))
                           errmsg(exmh);
                        }
...
#define AMPNOCHG  (KAMMF)
         ...
         *  1) More than one amplification code is not allowed.
         *  2) Amplification type cannot change between LHF and Hebb.
         *  3) 'Q,R,S,T,U,Z' bits permitted only if SBAR,RBAR,QBAR,MIJ
         *  already present as needed.  */
         {  unsigned long newkam,tkam;   /* Codes */
            ...
            for (ix=il->pct1; ix; ix=ix->pct) {
               ...
               *  to 0 and we've reached desired conntype) */
               ...
               ckkam(newkam);
               /* Make sure that if Q was selected, QBAR exists */
               if ((newkam & KAMDQ) && !ctexists(il, QBAR))
...
case kamway:               /* Read amplification scales */
            /* These scales may be used with conntypes having
            *  different rules.  At present, the warning for
            *  insufficient scales is in d3tchk, which by now
            *  has already run.  So scales are read into RP0->LCnD
            *  as a temp and info about number of scales read
            *  is ignored.  */
         {  getway(&RP0->LCnD);     /* Read in the scales */
            /* Load conntypes with amp scale values */
            for (ix=il->pct1; ix; ix=ix->pct) {
               /* Store new value if conntype index == -1 (store
               *  in all conntypes) or == 0 (ndx has decremented
               *  to 0 and we've reached desired conntype) */
...
case getfoff:              /* Read inhib falloff type */
         /* Names of falloff options (FOFF on GCONN card): */
         {  static char *foffkeys[NFOFFOPTS+1] = { "NONE",
               "1/D", "1/DSQ", "E-D", "E-DSQ",
               "1/R", "1/RSQ", "E-R", "E-RSQ",
               "1/S", "1/SSQ", "E-S", "E-SSQ" };
            struct INHIBBLK *ib = find_inhibblk(il, ndx);
            /* Errors found in match() will not be routed via
            *  errmsg(), but we save so many tests this way... */
            int ifo = match(RK_EQCHK, RK_MREQF, ~RK_COMMA, 0,
               foffkeys, NFOFFOPTS+1);
            if (ifo == 1) {      /* "NONE" */
               ib->ibopt &= ~IBOPFO; }
            else if (ifo > 1) {  /* Any option but "NONE" */
               ib->kfoff = ifo-2;
               ib->ibopt |= IBOPFO;
               if ((ib->ibopt & IBOPTX) &&
                  (ib->kbc == BC_TOROIDAL)) errmsg(efoffill);
               }
            } /* End getfoff local scope */
         break;
...
case getmxib:              /* Read gconn maximum contributions */
         ...
         {  struct INHIBBLK  *ib = find_inhibblk(il, ndx);
            ...
            if (pchop->type == getbeta)
               ...
               inform("(SV(^RB23/30IL$mV,V))", &structsize, &inib,
                  &pbnd->mxib, NULL);
