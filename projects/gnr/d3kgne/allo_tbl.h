...
/* $Id: allo_tbl.h 40 2010-11-03 16:02:24Z  $ */
/***********************************************************************
*                             CNS Program                              *
...
#define LXRM   2     /* sup(nds/8) = length of XRM data */
...
#define LIZVU 10     /* Bytes for B-G & Izhek. v,u and i3vr */

#define NumSpecialLengths 10  /* Number of special length codes */
  ...
  SHSIZE,            /* code 03: DST  (mV S7) or neg integer timer */
   -LXRM,            /* code 04: XRM  */
   LSIZE*PHASE_RES,  /* code 05: PHD  */
       0,            /* *** AVAILABLE SLOT (was AK) *** */
  -LCNDG,            /* code 07: CNDG */
  -LIONC,            /* code 08: IONC */
   LSmem,            /* code 09: QBAR (mV S7) */
  -LIZVU,            /* code 10: IZVU (2IL4S20 mV) */
   -LIZR,            /* code 11: IZRA+IZRB+IZRC+IZRD (S14) */
      };
...
*  present, alignment is forced back on a fullword boundary.  */

   char ordct[] = { IZVU, IONC, SBAR, QBAR, DST, DEPR,
      IZRA, CNDG, SAVE_LS_COUNT,
      PHD, XRM, RGH, END_OF_ALLOC_TABLE };

/* (iii) Connection type order table */

   char ordxn[] = { AK, IFD, NUK, END_OF_ALLOC_TABLE };

/* (iv) Connection type order table */
