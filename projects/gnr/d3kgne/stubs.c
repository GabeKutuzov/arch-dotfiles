...
/* $Id: stubs.c 28 2010-04-12 20:18:17Z  $ */
/***********************************************************************
*                             CNS Program                              *
*                                stubs                                 *
*                                                                      *
*   Stubs for routines that are currently omitted from Darwin III      *
*                                                                      *
...
void d3rpgt(FILE *a1) {
   ...
   *  Also, start any iterators that print/plot routines use.  */
   cryout(RK_P1,"0***d3rpgt called (not implemented)",RK_LN2,NULL);
   }
