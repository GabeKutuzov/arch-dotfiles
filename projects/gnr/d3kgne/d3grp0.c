/* (c) Copyright 1991-2007, Neurosciences Research Foundation, Inc. */
/* $Id: d3grp0.c 3 2008-03-11 19:50:00Z  $ */
/***********************************************************************
*                             CNS Program                              *
*                               d3grp0                                 *
*                                                                      *  
...
#ifdef D1
      /* DIGINPUT file options */
      {READ,BINARY,SEQUENTIAL,TOP,LOOKAHEAD,REWIND,RELEASE_BUFF },
#endif
      };
