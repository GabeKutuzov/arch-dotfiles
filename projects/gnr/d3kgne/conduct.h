/* (c) Copyright 2000-2006, Neurosciences Research Foundation, Inc. */
/* $Id: conduct.h 7 2008-05-02 22:16:44Z  $ */
/***********************************************************************
*                             CNS Program                              *
...
#define Lg            3       /* Length of conductance data, full
                              *  and per cell  (CNDG) */
#define LgHNT (Lg+2*SHSIZE)   /* Length of conductance with hit info */
#define ognh         Lg       /* Offset to number of hits */
#define ogth   (Lg+SHSIZE)    /* Offset to time of last hit */

/*---------------------------------------------------------------------*
*                    COND (Conductance or Channel)                     *
*                                                                      *
*  Option priority note:  If gDCY.omega is nonzero, traditional decay  *
*  is used.  This can occur with voltage-dependent (gKA in our paper)  *
*  or gated conductances.  Otherwise, C. Wellock's two-variable decay  *
*  method for alpha or double-exponent functions is used.              *
*---------------------------------------------------------------------*/
...
struct CONDUCT {
   ...
   union CDUn2 {              /* Activation info per cdflgs */
      ...
      struct {
         ...
         ui32  seed;             /* Random number seed */
         } psn;
      si32  at;                  /* Volt thresh (mV S20/27) */
      } uga;
   long  ogcat;               /* Offset to activation table */
...
#define CDFL_GgDCY   0x01        /* Cond is gated & omega != 0 */
#define CDFL_GNDCY   0x02        /* Cond is gated & omega == 0 */
...
#define CDKY_TYPE  0x80000000L   /* Not required: default PASSIVE */
#define CDKY_IOND  0x40000000L   /* Not required: default NO IONDEP */
#define CDKY_VREV  0x20000000L   /* Not required: default 0 */
#define CDKY_GEXP  0x10000000L   /* Not required: default 1 */
#define CDKY_OPT   0x08000000L   /* Not required: default NONE */
#define CDKY_REFR  0x04000000L   /* Not required: default 0 */
#define CDKY_IONC  0x02000000L   /* Not required unless OPT entered */
#define CDKY_DCUT  0x01000000L   /* Not required: default 0.01 */
#define CDKY_DCY   0x00800000L   /* Not required: CNS-style decay */
#define CDKY_ACTV  0x00400000L   /* Required if ALPHA or DOUBLE */
#define CDKY_GBAR  0x00200000L
#define CDKY_VTH   0x00100000L
#define CDKY_VMAX  0x00080000L
#define CDKY_TTPK  0x00040000L
#define CDKY_TAUM  0x00020000L
#define CDKY_TAUR  0x00010000L
#define CDKY_TAUD  0x00008000L
#define CDKY_IONA  0x00004000L
#define CDKY_PPPC  0x00002000L
#define CDKY_SEED  0x00001000L
#define CDKY_AT    0x00000800L
#else                            /* LITTLE-ENDIAN MACHINE */
#define CDKY_TYPE  0x00000080L   /* Not required: default PASSIVE */
#define CDKY_IOND  0x00000040L   /* Not required: default NO IONDEP */
#define CDKY_VREV  0x00000020L   /* Not required: default 0 */
#define CDKY_GEXP  0x00000010L   /* Not required: default 1 */
#define CDKY_OPT   0x00000008L   /* Not required: default NONE */
#define CDKY_REFR  0x00000004L   /* Not required: default 0 */
#define CDKY_IONC  0x00000002L   /* Not required unless OPT entered */
#define CDKY_DCUT  0x00000001L   /* Not required: default 0.01 */
#define CDKY_DCY   0x00008000L   /* Not required: CNS-style decay */
#define CDKY_ACTV  0x00004000L   /* Required if ALPHA or DOUBLE */
#define CDKY_GBAR  0x00002000L
#define CDKY_VTH   0x00001000L
#define CDKY_VMAX  0x00000800L
#define CDKY_TTPK  0x00000400L
#define CDKY_TAUM  0x00000200L
#define CDKY_TAUR  0x00000100L
#define CDKY_TAUD  0x00800000L
#define CDKY_IONA  0x00400000L
#define CDKY_PPPC  0x00200000L
#define CDKY_SEED  0x00100000L
#define CDKY_AT    0x00080000L
#endif
