...
/* $Id: yp2mf.c 5 2008-03-13 20:32:23Z  $ */
/***********************************************************************
...
*                                                                      *
*  This is the version that is used to implement the notation y' in    *
*  the documentation--it is the same as y2mf() except the current      *
