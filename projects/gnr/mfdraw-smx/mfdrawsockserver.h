...
#define  MFPREFS "/.mfprefs.txt"   /* Name of preferences file */
...
//#define MFLOG 1
//MFLOG when defined enables the logging out of the pre-parsed .mf type data input
//can be set using Makefile -D option

 #define BM_BW     0       /* Bitmap contains black and white */
 #define BM_GS     1       /* Bitmap is grey scale type per G. Reeke as of 5/3/2006 */
...
void error(char *msg);
void writetolog(char* buf);   //since stdout is occupied by socket traffic we use a disk file to hold error and other logout data
