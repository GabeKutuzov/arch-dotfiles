...
/* $Id: bbdcregt.c 17 2017-10-13 19:00:07Z  $ */
/***********************************************************************
*               BBD (Client Side) mex-Function Package                 *
*                             bbdcregt.c                               *
*                        Register a BBD camera                         *
*                                                                      *
*  This is the matlab mex-function version of bbdcregt().              *
*                                                                      *
...
*                                                                      *
*  MATLAB Synopsis:                                                    *
*     bbdcregt(BBDComm, camnm, camx, camy, kcol, kfreq)                *
*                                                                      *
*  Arguments:                                                          *
...
*  R17, 05/31/17, GNR - Revise bdflgs for additional color modes       *
***********************************************************************/
...
void mexFunction(int nlhs, mxArray *plhs[],
   ...
   *  arguments, then locate BBDComData */
   ...
   if (nlhs != 0 || nrhs != 6 || !mxIsChar(prhs[1]) ||
      ...
      abexitm(BBDcErrMexCall, "Bad arguments to bbdcregt");
   BBDcd = (struct BBDComData *)mxGetData(prhs[0]);
   if (!BBDcd)
      abexitm(BBDcErrMexCall, "Bad BBDcd arg to bbdcregt");
