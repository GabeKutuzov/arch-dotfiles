...
/* $Id: bbdcregs.c 17 2017-10-13 19:00:07Z  $ */
/***********************************************************************
*               BBD (Client Side) mex-Function Package                 *
*                             bbdcregs.c                               *
*                        Register a BBD sense                          *
*                                                                      *
*  This is the matlab mex-function version of bbdcregs().              *
*                                                                      *
*  Register a sensory array ("s" is for "sense" in bbdcregs) for       *
...
*                                                                      *
*  MATLAB Synopsis:                                                    *
*     bbdcregs(BBDComm, snsnm, snsx, snsy, ksns)                       *
*                                                                      *
*  Arguments:                                                          *
...
void mexFunction(int nlhs, mxArray *plhs[],
   ...
   *  arguments, then locate BBDComData */
   ...
   if (nlhs != 0 || nrhs != 5 || !mxIsChar(prhs[1]) ||
         ...
         !mxIsInt32(prhs[4]))
      abexitm(BBDcErrMexCall, "Bad arguments to bbdcregs");
   BBDcd = (struct BBDComData *)mxGetData(prhs[0]);
   if (!BBDcd)
      abexitm(BBDcErrMexCall, "Bad BBDcd arg to bbdcregs");
