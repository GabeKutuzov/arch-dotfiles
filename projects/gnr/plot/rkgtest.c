...
#if 1
   setmf("rkgtest.mf", /*"localhost:0"*/NULL, "RKG PLOT LIBRARY TEST", NULL,
      8000, 0, 'B', 0, 0);
...
*---------------------------------------------------------------------*/
   ...
   newplt(PLSIZE,PLSIZE,0,0,"SOLID","BLACK","DEFAULT",SKP_XG);
...
/*   symbc(0, " Text added by symbcxxx", 0, 20);  */
   ...
   //for(zxi; zxi < 9000; zxi++) {line(26,30,17,18);} // gmk temp
#endif
#ifndef PAR0
   pencol("RED");
