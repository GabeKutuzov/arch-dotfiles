...
/* $Id: allocpmv.c 3 2017-01-16 19:29:37Z  $ */
/***********************************************************************
*                          MPI Tools Library                           *
*                              allocpmv                                *
*                                                                      *
*  This routine is the mallocv() analog in a shared memory management  *
*  package for parallel computers.  On serial computers, it is similar *
*  to traditional mallocv() except for maintaining a running total of  *
...
*              The memory is not necessarily initialized to zero.      *
...
*              indicate what was being allocated.                      *
*                                                                      *
************************************************************************
...
void *allocpmv(memtype kmem, si32 mtype, char *emsg) {
   ...
   if ((pmem=(void *)allocpm(kmem, mtype)) == NULL && emsg)
      abexitm(MP_ALLOC_FAIL, ssprintf(NULL, "Memory alloc failed "
         "for %48s (%10zd bytes requested).", emsg,
