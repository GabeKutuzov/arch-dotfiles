...
/* $Id: nmitrsaf.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
...
*              found in possibly a series of nmitrsaf() calls since    *
*              the last call to nminitf().                             *
*              N.B.  Swapping this vector back into the simplex        *
*              before another call to nmitrsaf() can in principle      *
...
int nmitrsaf(struct nmglblf *nmG, void *usrd, nmxyf **ppxbest,
      nmxyf *pybest, ui32 *pniter, nmxyf T,
   ...
   nmxyf  yrf,ytf;               /* Fluctuated y values */
