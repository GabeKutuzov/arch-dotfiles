...
/* $Id: nmitrnad.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
...
*              found in possibly a series of nmitrnad() calls since    *
*              the last call to nminitd().                             *
*              N.B.  Swapping this vector back into the simplex        *
*              before another call to nmitrnad() can in principle      *
...
*                                                                      *
*  Returns:    A return code defined in nelmeadd.h as follows:         *
...
int nmitrnad(struct nmglbld *nmG, void *usrd, nmxyd **ppxbest,
   ...
   /* Names of moves in same order as NMKM defines in nelmeadd.h */
