...
/* $Id: lemfmil.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
*                  ROCKS Library - C Implementation                    *
*                               lemfmil                                *
*                                                                      *
*  ROCKS library routine for storing long integer data in a binary     *
*  data file in standard little-endian format.  It is assumed that the *
...
*                                                                      *
*  This routine is the same as lemfmi8 when longs are 64-bits, but     *
...
/* A long is 4 bytes */
   ...
   m[4] = m[5] = m[6] = m[7] = (il >= 0) ? 0 : BYTE_MAX;
