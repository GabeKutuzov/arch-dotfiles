...
/* $Id: nwndevd.c 15 2009-12-30 22:02:21Z  $ */
/***********************************************************************
...
*  distributed pseudorandom doubles with a given mean and standard     *
...
*  nonzero.                                                            *
*                                                                      *
*  Synopsis:  void nwndevd(double *dr, wseed *seed, long n,            *
...
/* Multiply by standard deviation and add mean (r is S28) */
      ...
      if (rand & b22) r = -r;
      *dr++ = (((double)r * sigma / 268435456.0) + mean);
      }
