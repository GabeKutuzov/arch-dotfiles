...
/* $Id: dsrswwqe.c 63 2017-04-13 20:47:00Z  $ */
/***********************************************************************
...
*  This is the version that calls e64act(ec) when there is an overflow.*
*                                                                      *
*  Synopsis: si64 dsrswwqe(si64 x, si64 y, int s, int ec)              *
*                                                                      *
*  Arguments:                                                          *
*     x        64-bit numerator.                                       *
*     y        64-bit divisor.                                         *
...
*  version saves call overhead and avoids a double call to e64act() on *
*  quotient overflow.                                                  *
*                                                                      *
...
*  ==>, 05/26/13, GNR - Last date before committing to svn repository  *
...
si64 dsrswwqe(si64 x, si64 y, int s, int ec) {
   ...
   if (ux.xu32[1] | ux.xu32[2] & ~SI32_MAX) {
      e64act("dsrswwqe", ec); ux.xs64[1] = SI64_MAX; }
