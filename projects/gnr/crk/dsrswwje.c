...
/* $Id: dsrswwje.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
...
*                                                                      *
*  Synopsis: si32 dsrswwje(si64 x, si64 y, int s, int ec)              *
*                                                                      *
*  Arguments:                                                          *
*     x        64-bit numerator.                                       *
*     y        64-bit divisor.                                         *
...
*  purpose of this routine is to avoid a double call to e64act() in    *
...
si32 dsrswwje(si64 x, si64 y, int s, int ec) {
   ...
   if (ux.xu32[1] | ux.xu32[2] | ux.xu32[3] & ~SI32_MAX) {
      e64act("dsrswwje", ec); ux.xu32[3] = SI32_MAX; }
   ...
   if (ux.xu32[4] | ux.xu32[3] | ux.xu32[2] & ~SI32_MAX) {
      e64act("dsrswwje", ec); ux.xu32[2] = SI32_MAX; }
