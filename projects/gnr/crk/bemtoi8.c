...
/* $Id: bemtoi8.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
*                  ROCKS Library - C Implementation                    *
*                               bemtoi8                                *
*                                                                      *
*  ROCKS library routine for retrieving long long integer data from a  *
...
#error Special bemtoi8 routine needed on this machine
#endif
...
si64 bemtoi8(char *m) {
   ...
   register byte *um = (byte *)m;
   si64 i8;
   i8.hi = ((((((ui32)um[0] << BITSPERBYTE) |
      (ui32)um[1]) << BITSPERBYTE) | (ui32)
      um[2]) << BITSPERBYTE) | (ui32)um[3];
   i8.lo = ((((((ui32)um[4] << BITSPERBYTE) |
