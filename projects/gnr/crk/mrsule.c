...
/* $Id: mrsule.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
*                  ROCKS Library - C Implementation                    *
*                               mrsule                                 *
*                                                                      *
*  This function is the unsigned version of mrssle.  It multiplies a   *
...
*                                                                      *
*  Synopsis: ui32 mrsule(ui32 x, ui32 y, int s, int ec)                *
*                                                                      *
...
************************************************************************
*  V1A, 10/15/09, GNR - New routine, based on msrule                   *
*  ==>, 10/15/09, GNR - Last date before committing to svn repository  *
***********************************************************************/
