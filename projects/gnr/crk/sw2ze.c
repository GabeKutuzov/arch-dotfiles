...
/* $Id: sw2ze.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
...
*  already 64-bit, rkarith.h will define sw2ze as a macro (overflow    *
*  is not possible).                                                   *
*                                                                      *
*  Synopsis: size_t sw2ze(si64 x, int ec)                              *
*                                                                      *
...
#if ZSIZE == WSIZE
#error sw2ze should not be compiled if ZSIZE == WSIZE
#endif

long sw2ze(si64 x, int ec) {
