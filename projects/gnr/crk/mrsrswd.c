...
/* $Id: mrsrswd.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
...
*                                                                      *
*  Synopsis: si64 mrsrswd(si64 x, si32 y, int s)                       *
*                                                                      *
*  Notes:                                                              *
...
*                                                                      *
************************************************************************
*  V1A, 10/24/13, GNR - New routine, based on msswe                    *
   ...
   if ((ds = s - BITSPERUI32) >= 0) {
      if (ds == 0) {
         ...
         *  The sum cannot overflow and there is no shift.  */
         return p1.ps + (p0.pu >> (BITSPERUI32-1) & UI64_01);
         }
      else {
