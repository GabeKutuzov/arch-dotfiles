...
/* $Id: dmrswwqe.c 64 2017-09-15 17:55:59Z  $ */
/***********************************************************************
...
*  This is the version that uses the error code passed as ec argument. *
*                                                                      *
*  Synopsis: si64 dmrswwqe(si64 x, si64 y, si32 m, int ec)             *
*                                                                      *
*  Arguments:                                                          *
*     x        64-bit numerator.                                       *
*     y        64-bit divisor.                                         *
*     m        32-bit multiplier.                                      *
*     ec       Error code to pass to e64act in case of overflow.       *
*                                                                      *
   ...
   *  Always use vdivl() if no native 64-bit arithmetic.  */
   ...
   if (ux.xu32[1]) {
      ...
      if (ux.xu32[1] | ux.xu32[2] & SI32_SGN) {
         e64act("dmrswwqe", ec); ux.xs64[1] = SI64_MAX; }
#ifdef HAS_I64
   } else {
