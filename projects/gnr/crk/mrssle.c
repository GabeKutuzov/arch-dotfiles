...
/* $Id: mrssle.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
*                  ROCKS Library - C Implementation                    *
*                               mrssle                                 *
*                                                                      *
*  mrssle multiplies a 32-bit signed integer by a 32-bit signed        *
*  integer, scales the 62-bit intermediate product by a specified      *
*  right shift, and returns the low-order 32 bits of the result,       *
*  reporting an over-flow if the result exceeds 32 bits.  This is      *
*  the version that uses the error code passed as an argument.         *
*                                                                      *
...
*                                                                      *
*  Synopsis: si32 mrssle(si32 x, si32 y, int s, int ec)                *
*                                                                      *
...
*  ==>, 12/31/08, GNR - Last date before committing to svn repository  *
*  Rev, 10/16/09, GNR - Correct NOI64 overflow test p0 '>=', not '>'   *
