...
/* $Id: sorti.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
*                  ROCKS Library - C Implementation                    *
*                                SORTI                                 *
*               Perform radix sort on items in a vector                *
*                                                                      *
*  This is a version of CRK sort2() modified to work with data that    *
*  are contained in a linear array (vector) of either simple variables *
*  or structures containing the sorting key, i.e. not a linked list.   *
*  It performs a radix sort in increasing or decreasing order.  Keys   *
*  may consist of character strings, fixed- or floating-point, posi-   *
*  tive or negative numeric data of any byte length.  The algorithm    *
*  adjusts the key bin size according to the number of data items.     *
*                                                                      *
*  Usage:  void *sorti(const void *pdata, ulng *psort, ulng *work,     *
*     ulng ndat, int ldat, int okeys, int lkeys, int ktype)            *
*                                                                      *
*  Prototyped in:                                                      *
*     rocks.h, rksubs.h                                                *
*                                                                      *
*  Arguments:                                                          *
*     'pdata' points to an array containing the data to be sorted.     *
*  The data are not modified by the sort.                              * 
*                                                                      *
*     'psort' points to an array of type unsigned long and length      *
*  equal to the number of data items to be sorted.  It is used to      *
*  return an array of the indices of the data in sorted order.  For    *
*  example, if pdata = { 5, 19, 3, 12 }, and an increasing sort is     *
*  performed, the sorted result index array contains { 2, 0, 3, 1 }.   *
*                                                                      *
*     'work' is a pointer to a work area large enough to contain       *
*  32 unsigned longs if ndat < 256, otherwise 512 unsigned longs.      *
*  The contents are modified during the operation of this routine.     *
*                                                                      *
*     'ndat' is the number of items in the data to be sorted.          *
...
*                                                                      *
*  Value returned:  sorti returns a pointer to the first structure     *
