...
/* $Id: mrsrule.c 61 2017-01-16 19:26:44Z  $ */
/***********************************************************************
*                  ROCKS Library - C Implementation                    *
*                               mrsrule                                *
*                                                                      *
*  This function is the unsigned version of mrsrsle.  It multiplies a  *
...
*                                                                      *
*  Synopsis: ui32 mrsrule(ui32 x, ui32 y, int s, int ec)               *
*                                                                      *
...
************************************************************************
*  V1A, 10/11/09, GNR - New routine, based on msrsle                   *
*  ==>, 10/11/09, GNR - Last date before committing to svn repository  *
***********************************************************************/
