...
/* $Id: epks2sd.c 8 2015-11-25 20:04:01Z  $ */
/***********************************************************************
...
*  Kolmogorov-Smirnov statistic using the "equi-partitioned" approxi-  *
*  mation that distributes data points in overlapping bricks equally   *
*  among quadrants that match in overlapping dimensions.               *
*                                                                      *
...
*  epks2s.c, which contains the actual code to compute the statistic.  *
*  Usage instructions are in the README file and in epks2s.c           *
*                                                                      *
*  Reference:                                                          *
...
************************************************************************
*  V1A, 07/18/15, G.N. Reeke - New program                             *
