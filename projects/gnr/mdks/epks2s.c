...
/* $Id: epks2s.c 8 2015-11-25 20:04:01Z  $ */
/***********************************************************************
...
*  distinguishable.  This version computes the "equi-partitioned"      *
...
*  along with pointers to the two data sets to be compared.  epks2sx() *
...
*                                                                      *
*  MATLAB Synopsis:                                                    *
*     s = epks2sx(MDSKCOM, X1, X2)                                     *
*  C or C++ Synopsis:                                                  *
*     double epks2sx(void *pwk, Xdat const *X1, Xdat const *X2)        *
*                                                                      *
*  Arguments:                                                          *
...
*  makefile.  If compiled without external definitions, epks2s will    *
*  default to double-precision data with integer ni and name 'epks2s'. *
*  (This indirect method is used because #if cannot test strings.)     *
*=====================================================================*/

#ifdef I_AM_MATLAB
#define MyName vfnmex("epks2s",VL)

enum rhss2args { jwk, jX1, jX2 };

/*=====================================================================*
*                    epks2sx mex function wrapper                      *
*=====================================================================*/
...
/* Perform the statistical computation and return the result */
   ...
   s = vfnname(epks2s,VL)(pwk, pX1, pX2);
...
double vfnname(epks2s,VL)(void *pwk, Xdat const *X1, Xdat const *X2) {
   ...
   if ((s1 = vfnname(epks1s,VL)(pwk, X1, X2)) <= 0.0) return s1;
   if ((s2 = vfnname(epksqd,VL)(pwk, IX2)) <= 0.0) return s1;
