...
/* $Id: bfks1sd.c 1 2014-04-21 19:53:00Z  $ */
/***********************************************************************
...
*                                                                      *
*  This is the brute-force single-sample version for double-precision  *
*  floating point data and integer number of data points.              *
*                                                                      *
*  Usage:                                                              *
*     This file defines data type codes, then #includes the file       *
*  bfks1s.c, which contains the actual code to compute the statistic.  *
*  Usage instructions are in the README file and in bfks1s.c           *
*                                                                      *
*  Reference:                                                          *
...
*  ==>, 12/05/13, GNR - Last date before committing to svn repository  *
***********************************************************************/
