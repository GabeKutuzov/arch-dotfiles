...
/* $Id: epks2sf.c 8 2015-11-25 20:04:01Z  $ */
/***********************************************************************
...
*  statistic using the "equi-partitioned" approximation that distri-   *
*  butes data points in overlapping bricks equally among quadrants     *
*  that match in overlapping dimensions.                               *
*                                                                      *
...
*  epks1s.c, which contains the actual code to compute the statistic.  *
*  Usage instructions are in the README file and in epks1s.c           *
*                                                                      *
*  Reference:                                                          *
