...
/* $Id: upks2sf.c 8 2015-11-25 20:04:01Z  $ */
/***********************************************************************
...
*  mdksallof() to create a work area that is passed to this program    *
...
*  Usage instructions are in the README file and in upks1s.c           *
*                                                                      *
*  Reference:                                                          *
